...
\noindent If the collection does not exist, an error of type \symbolref{INEXISTENT-DATABASE-COLLECTION} is signalled.
...
\noindent If the \inline{data} contains an \symbolref{_id} field or an inexistent field, an error of type \symbolref{DATABASE-INVALID-FIELD} is signalled. If the collection does not exist, an error of type \symbolref{INEXISTENT-DATABASE-COLLECTION} is signalled. 
...
\noindent If the \inline{data} contains an \inline{_id} field or an inexistent field, an error of type \symbolref{DATABASE-INVALID-FIELD} is signalled. If the collection does not exist, an error of type \symbolref{INEXISTENT-DATABASE-COLLECTION} is signalled. 
