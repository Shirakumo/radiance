...
(defvar *radiance-acceptors*   ()  "List of all Hunchentoot acceptors that run this server.")
(defvar *radiance-handlers*    ()  "List of Hunchentoot handlers.")
...
(declaim (hash-table *radiance-hooks* *radiance-api-formats*))
