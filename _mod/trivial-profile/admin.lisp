...
(core:define-api fields/add (field type value public) (:method :POST :access-branch "admin.profile.fields")
  (db:insert "trivial-profile-fields" `(("field" . ,field) ("type" . ,type) ("value" . ,value) ("public" . ,public)))
  (server:redirect "/profile/fields"))

(core:define-api fields/edit (orig-field field type value public) (:method :POST :access-branch "admin.profile.fields")
...
(core:define-api fields/delete () (:method :POST :access-branch "admin.profile.fields")
