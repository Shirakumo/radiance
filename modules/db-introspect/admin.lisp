...
(admin:define-panel database database (:access-branch "admin.database.*" :icon "fa-calendar" :tooltip "Show all collections in the database")
  (r-clip:process
   (plump:parse (template "database.ctml"))
   :collections (db:collections)))

(admin:define-panel collection database (:access-branch "admin.database.collection.*" :icon "fa-table" :tooltip "View collection contents")
...
(admin:define-panel record database (:access-branch "admin.database.collection.record.*" :icon "fa-list-alt" :tooltip "View record contents")
  (let ((collection (post/get "collection"))
        (confirm (post/get "confirm"))
        (id (post/get "id"))
        (action (post/get "action")))
